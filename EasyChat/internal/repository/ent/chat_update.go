...
func (cu *ChatUpdate) SetUsersID(id int) *ChatUpdate {
	cu.mutation.SetUsersID(id)
	return cu
}

// SetNillableUsersID sets the "users" edge to the User entity by ID if the given value is not nil.
func (cu *ChatUpdate) SetNillableUsersID(id *int) *ChatUpdate {
	if id != nil {
		cu = cu.SetUsersID(*id)
	}
	return cu
...
func (cu *ChatUpdate) SetUsers(u *User) *ChatUpdate {
...
func (cu *ChatUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if cu.mutation.UsersCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{chat.UsersColumn},
			Bidi:    false,
...
// SetUsersID sets the "users" edge to the User entity by ID.
func (cuo *ChatUpdateOne) SetUsersID(id int) *ChatUpdateOne {
	cuo.mutation.SetUsersID(id)
	return cuo
}

// SetNillableUsersID sets the "users" edge to the User entity by ID if the given value is not nil.
func (cuo *ChatUpdateOne) SetNillableUsersID(id *int) *ChatUpdateOne {
	if id != nil {
...
// SetUsers sets the "users" edge to the User entity.
func (cuo *ChatUpdateOne) SetUsers(u *User) *ChatUpdateOne {
